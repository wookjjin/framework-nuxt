    ...
    <div class="flex flex-col mx-6 px-6 gap-8 overflow-y-auto">
      ...
      <section>
        ...
        <p class="text-gray-500 mb-6">
          색상(<span class="font-semibold">color</span>) 속성을 통해 체크박스의 테마를 지정할 수 있습니다.<br>
      ...
      <section>
        ...
        <p class="text-gray-500 mb-6">
          <span class="font-semibold">variant</span> 속성을 통해 체크박스의 스타일 테마를 변경할 수 있습니다.<br>
          <span class="font-semibold">list</span>일반적인 리스트형 체크박스로, 라벨과 설명이 텍스트 위주로 표시되고, <span
            class="font-semibold"
      ...
      <section>
        ...
        <p class="text-gray-500 mb-6">
          다양한 크기(<span class="font-semibold">sm, md, lg</span>) 옵션을 제공하여 UI 환경에 맞게 조정할 수 있습니다.<br>
      ...
      <section>
        ...
        <p class="text-gray-500 mb-6">
          <span class="font-semibold">icon</span> 또는 <span class="font-semibold">indeterminateIcon</span> 속성을 사용해 체크 표시를
          커스텀할 수 있습니다.<br>
      ...
      <section>
        ...
        <p class="text-gray-500 mb-6">
          <span class="font-semibold">description</span> 속성을 사용해 체크박스 아래에 추가 설명을 표시할 수 있습니다.<br>
      ...
      <section>
        ...
        <p class="text-gray-500 mb-6">
          <span class="font-semibold">disabled</span> 속성을 사용해 비활성화된 상태를 표시할 수 있습니다.<br>
